...
class CNCController:
    ...
    def move_to_machine_home(self):
        ...
        # Move away from limit switches (pull-off)
        print('Moving away from limit switches...')
        self.serial_port.write(b'G91\n')  # Relative mode
        time.sleep(0.1)

        # Pull off from switches (adjust distances based on your machine)
        # Typical: move -5mm in X, -5mm in Y, -2mm in Z
        self.serial_port.write(b'G01 X-5 Y-5 Z-2 F500\n')
        time.sleep(1)
        ...
        self.ycoord = 0.0
        self.zcoord = 0.0
        print('CNC machine homed and pulled off from limit switches')
